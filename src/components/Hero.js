      ...
      <div className="hero-inner container">
        <div className="hero-content">
          ...
          <div className="hero-socials">
            <a href="https://github.com/AbhilashFrancis88" target="_blank" rel="noreferrer" aria-label="GitHub">
            ...
            <a href="https://linkedin.com/in/abhilash-francis-66971118a" target="_blank" rel="noreferrer" aria-label="LinkedIn">
